      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/silaspath"
  ...
  return (
    ...
    >
      <h2 className="relative flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Interested in web development mastery?</span>
      </h2>
      ...
      >
        <Script
          ...
          data-button-text-color="#aaFFF"
          data-site="https://skill-speed.ghost.io"
          async
        />
      </div>
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image4, image1, image2, image3].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
